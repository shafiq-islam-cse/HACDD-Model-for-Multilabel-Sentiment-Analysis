...
EMBEDDING_FILE = 'D:/My Spyder/0 toxic comments classification/glove.6B.100d.txt'
...
def get_model():
    ...
    x = LSTM(gru_len, activation='relu', dropout=dropout_p, recurrent_dropout=dropout_p, return_sequences=True)(embed_layer)
